...
export const renderUpperPrimaryReport = async (
  result: any,
  student: any,
  tenant: any,
        ...
        <div>
          ...
          <table style="width: 100%; border-collapse: collapse; border: 1.5px solid #cbd5e1; margin-bottom: 16px; font-size: 8.5px;">
            ...
            <tr>
              ...
              <td style="padding: 4px 6px; border: 1px solid #cbd5e1;"><span style="color: ${primaryColor}; font-weight: bold;">D.O.B:</span> <strong>${escapeHtml(formattedDob)}</strong></td>
